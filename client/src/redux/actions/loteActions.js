...
export function crearLoteManejo (data, id) {
    ...
    return axios.post(`${REACT_APP_API_HEROKU}/lote/createManejo/${id}`, data)
...
export function deleteManejo (id) {
    ...
    return axios.delete(` ${REACT_APP_API_HEROKU}/lote/deleteManejo/${id}`)
    .then(response => response)
    .catch(e => console.log(e))
...
export function updateLot (data, id) {
    ...
    return axios.put(` ${REACT_APP_API_HEROKU}/lote/${id}`, data)
    .then(response => response)
    .catch(e => console.log(e))
