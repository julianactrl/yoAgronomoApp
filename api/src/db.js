...
const { DB_USER, DB_PASSWORD, DB_HOST, DB_NAME, DATABASE_URL_LOCAL, DATABASE_URL , DATABASE_LOCAL} = process.env;
dbRDS = false;


const sequelize = new Sequelize(`${DATABASE_LOCAL}?sslmode=require`, {
  //
  // ssl: true,
  protocol: "postgres",
  logging: false,
